    ...
    <main className="min-h-screen flex items-center justify-center px-4">
      <div className="max-w-5xl w-full grid gap-10 md:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-center">
        <div className="text-accent">
          ...
          <Image src="/images/partner.png" alt="BetterBugs" width={500} height={100} className="md:w-1/2 w-3/4 md:mb-4 md:my-0 my-6 mx-auto" />
          <h2 className="text-3xl md:text-4xl font-bold flex items-center gap-1 text-white mb-4">
            <span>Spin the wheel</span>
            <Image src="/images/wheel.png" alt="Wheel" width={500} height={100} className="w-8" />
          </h2>
